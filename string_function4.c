...
char **strtow(char *input_str, char *delimiters)
{
	...
	for (i = 0; input_str[i] != '\0'; i++)
		if (!is_delim(inpu: A pointer to an array of strings, or NULL on failure.
 */
																	...
																	result_array[j][m] = input_str[i++];
																			result_array[j][m] = 0;
																					...
																					result_array[j] = NULL;
																						 ...
																						 *  		    																												if (!result_array[j])
																						 *  		    																														{
																						 *  		    																																	fo2 - Splits a string into words.
																						 *  		    																																	 * @input_str: The input string.
																						 *  		    																																	  * @delimiter: The delimiter.
																						 *  		    																																	   *
																						 *  		    																																	    * Returnif (input_str == NULL || input_str[0] == 0)
		return (NULL);
	for (i = 0; input_str[i] != '\0'; i++)
