...
char **list_to_strings(list_t *head)
{
	...
	size_t length = list_length(head), index;
	char **strings_array;
	char *string;
...
/**
 * node_starts_with_prefix - returns a node whose string starts with the prefix
 ...
 */
list_t *node_starts_with_prefix(list_t *head, char *prefix, char next_char)
{
	char *result = NULL;
